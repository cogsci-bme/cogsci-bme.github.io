  ...
  <div class="wrap">
    <div class="prose">
      <dl class="facts" style="grid-template-columns:1fr">
        ...
        <div class="fact"><dt>Tanulmányi kérdések, problémák</dt><dd><a href="mailto:{{ site.contact.email_tanulmanyi }}">{{ site.contact.email_tanulmanyi }}</a></dd></div>
        <div class="fact"><dt>Facebook</dt><dd><a href="{{ site.contact.facebook }}">facebook.com/BME.KOGNITIV</a></dd></div>
        <div class="fact"><dt>Térkép</dt><dd><a href="https://www.openstreetmap.org/?mlat=47.4735&amp;mlon=19.0596#map=18/47.4735/19.0596" target="_blank" rel="noopener">Megnyitás az OpenStreetMapen</a></dd></div>
      </dl>
    </div>
  </div>
</section>
